...
ImageGallery({Key key, this.images,this.onChange,this.editable=false}) : super(key: key);
                  ...
                  Row(
                    ...
                    children:   [
                      Center(
                          child: InkWell( 
                            onTap: left, 
                            child: Icon(Icons.chevron_left, size: size*0.2,color: primaryColor,),
                          )
                      ),
                      FittedBox(
                        fit: BoxFit.contain,
                      ...
                      Center(
                          child: InkWell( 
                            onTap: right,
                            child: Icon(Icons.chevron_right, size: size*0.2,color: primaryColor,),
                          )
                      ),
                    ],
                  ),
